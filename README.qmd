...
````
`r rinline("tn_fna(206)")`, also known as papyrus, is a tall sedge growing in reed-like swamp vegetation in shallow water.
`r rinline("tn_an(206)")` has a very long history of use by humans as one of the first types of paper ever made.
````
