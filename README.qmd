...
<!-- badges: start -->
<!--
[![cran checks](https://badges.cranchecks.info/worst/taxnames.svg)](https://cran.r-project.org/web/checks/check_results_biblio.html)
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/taxnames)](https://cran.r-project.org/package=taxnames)
...
[![Codecov test coverage](https://codecov.io/gh/kamapu/taxnames/branch/main/graph/badge.svg)](https://codecov.io/gh/kamapu/taxnames?branch=main)
[![CRAN_downloads](http://cranlogs.r-pkg.org/badges/taxnames)](https://cran.r-project.org/package=taxnames)
[![total downloads](http://cranlogs.r-pkg.org/badges/grand-total/taxnames)](https://cran.r-project.org/package=taxnames)
<!-- badges: end -->
