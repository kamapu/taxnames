...
tn_tab <- data.frame(
  Description = c("Full usage name without author name",
  ...
  Call = c("`tn_fun(52612)`",
      ...
      "`tn_aun(52612)`",
      "`tn_auna(52612)`"),
  Output = c(tn_fun(52612), tn_funa(52612), tn_aun(52612),
      tn_auna(52612))
)
...
````
`r rinline("tn_fna(206)")` belongs to the genus `r rinline("tn_pfna(206, \"genus\")")` and to the family `r rinline("tn_pfna(206, \"family\", italics = FALSE)")`
````
